...
def main():
    ...
    try:
        ...
        generate_docs(index_path, output_dir=document_dir, output_file="procedures6.md", llm_provider=llm_choice)
        print(Colours.GREEN + "Documentation generated in 'document/procedures6.md'" + Colours.RESET)
